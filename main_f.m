...
for i = 1:350%350%571%max_Frame
 frameNo = frameNo + 1;   
    ...
    for s = 1:5
        switch s
         case 1                 
            ...
            Center(yMin_Ind).Centroid(1) = NaN;%для того чтобы  больше не
                                               %учавствовал                                                      
         otherwise                                                    
    ...
    for z = 1:4
        switch z
            case 1
                %угол между вектором {1,2} и вертикальной линией
                mark1=1; mark2=2; mark3=0; mark4 = 0; 
            case 2
                %угол между векторами {2,1} и {2,3}
                mark1=2; mark2=1; mark3=2; mark4 = 3;
            case 3
                %угол между векторами {3,2} и {4,5}
                mark1=3; mark2=2; mark3=4; mark4 = 5;
            case 4
                %угол между вектором {4,5} и горизонтальной линией
